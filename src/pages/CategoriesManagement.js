...
const CategoriesManagement = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(`Failed to ${modalType === 'create' ? 'create' : 'update'} category`);
    }
  };
  ...
  const getStatusBadge = (category) => {
    ...
    if (!category.isActive) {
      badges.push(
        <span key="inactive" className={`px-2 py-1 text-xs font-medium rounded-full transition-colors duration-300 ${
          isDarkMode 
      ...
      badges.push(
        <span key="active" className={`px-2 py-1 text-xs font-medium rounded-full transition-colors duration-300 ${
          isDarkMode 
    ...
    if (category.featured) {
      badges.push(
        <span key="featured" className={`px-2 py-1 text-xs font-medium rounded-full transition-colors duration-300 ${
          isDarkMode 
      ...
      <div className="mb-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            }`}>Manage consultation categories and subcategories</p>
          </div>
          <button
        ...
        <div className={`rounded-lg shadow-lg p-6 transition-all duration-300 hover:scale-105 ${
          ...
          <div className="flex items-center">
            <div className={`p-2 rounded-lg transition-colors duration-300 ${
              ...
              <FolderIcon className={`h-6 w-6 transition-colors duration-300 ${
        ...
        <div className={`rounded-lg shadow-lg p-6 transition-all duration-300 hover:scale-105 ${
          ...
          <div className="flex items-center">
            <div className={`p-2 rounded-lg transition-colors duration-300 ${
              ...
              <FolderOpenIcon className={`h-6 w-6 transition-colors duration-300 ${
        ...
        <div className={`rounded-lg shadow-lg p-6 transition-all duration-300 hover:scale-105 ${
          ...
          <div className="flex items-center">
            <div className={`p-2 rounded-lg transition-colors duration-300 ${
              ...
              <TagIcon className={`h-6 w-6 transition-colors duration-300 ${
        ...
        <div className={`p-6 border-b transition-colors duration-300 ${
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor="parentOnly" className={`ml-2 text-sm transition-colors duration-300 ${
          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className={`divide-y transition-colors duration-300 ${
              ...
              {filteredCategories.map((category) => (
                <tr key={category._id} className={`transition-colors duration-300 ${
              ...
              {filteredCategories.length === 0 && (
                <tr>
                  <td colSpan="6" className={`px-6 py-4 text-center transition-colors duration-300 ${
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className={`text-sm transition-colors duration-300 ${
                      ...
                      {selectedCategory?.parentCategory ? 'Subcategory' : 'Parent Category'}
                    </p>
                  </div>
                  {selectedCategory?.parentCategory && (
                    <div>
                      ...
                      <p className={`text-sm transition-colors duration-300 ${
                        isDarkMode ? 'text-white' : 'text-gray-900'
                      }`}>{selectedCategory.parentCategory.name}</p>
                    </div>
                  )}
                  <div>
                    <label className={`text-sm font-medium transition-colors duration-300 ${
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded"
                        />
                        <label htmlFor="featured" className={`ml-2 block text-sm transition-colors duration-300 ${
                          isDarkMode ? 'text-gray-300' : 'text-gray-900'
                        }`}>
                          Featured
                        </label>
